<template>
  <div class="profile-card">
    <div class="profile-header">
      <v-avatar size="140">
        <img v-if="!imageError" width="130" height="130" :src="`https://lets-to-gether.online/api/auth/v1/img/${participant.pathToAvatar}`" @error="handleImageError" alt="User Avatar">
